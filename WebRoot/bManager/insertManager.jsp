...
<form action="../servlet/managerServlet?action=add" method="post" onSubmit="return Mycheck()" name="form">
	<table width="415" border="1" cellpadding="0" cellspacing="0">
      <tr>
        <td width="75" height="30" align="center">账号</td>
        <td width="334" align="center">&nbsp;&nbsp;<input  size="50" type="text" name="account"/></td>
      </tr>
         <tr>
        <td width="75" height="30" align="center">密码</td>
        <td width="334" align="center">&nbsp;&nbsp;<input size="50" type="password" name="password"/></td>
      </tr>
         <tr>
        <td width="75" height="30" align="center">姓名</td>
        <td width="334" align="center">&nbsp;&nbsp;<input size="50" type="text" name="name"/></td>
      </tr>
